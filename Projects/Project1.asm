...
goodbye db "GOODBYE!",10,13,"CREATED BY:",10,13,"Sarah Jamani,Mumta Punjwani,Kumkum Wadhwani,Shiv Kumar$" ;This will execute out program with good bye msg and with our names
